...
<head>
    ...
    <title>Developers Cup | DevelopHowTo</title>
...
<![endif]-->
    ...
    <main>
        ...
        <!-- ./Page header -->
        <header class="header section parallax image-background overlay gradient gradient-53 alpha-8 color-1" style="background-image: url('img/bg/developersjam.jpg')">
            <div class="container overflow-hidden">
                <div class="row">
                    <div class="col-md-8">
                        <p class="lead bold">Developers Cup!</p>
